...
<template>
  <section class="relative py-20 md:py-[120px]">
    <div class="dark:bg-dark absolute left-0 top-0 z-0 h-full w-full bg-slate-50 dark:bg-slate-900" />
    <div
    ...
    <div class="container z-10 bg-transparent px-4">
      <div class="relative -mx-4 flex flex-wrap items-center bg-transparent">
        <div class="w-full px-4 lg:w-7/12 xl:w-8/12">
          <div class="ud-contact-content-wrapper">
            <div class="ud-contact-title mb-12 lg:mb-[150px]">
              ...
              <h2 class="text-dark max-w-[260px] text-[35px] font-semibold leading-[1.14] dark:text-white">
                {{ title }}
              </h2>
            </div>
              ...
              <div class="mb-8 flex w-[330px] max-w-full">
                ...
                <div>
                  ...
                  <p class="text-body-color dark:text-dark-6 text-base">
                    <NuxtLink to="https://www.google.com/maps?q=4006+Drake+Ave.,+Huntsville,+AL+35805" target="_blank"
                      class="text-primary">
                      {{ location }}
                    </NuxtLink>
                  </p>
        ...
        <div v-if="showForm" class="w-full px-4 lg:w-5/12 xl:w-4/12">
          <div
            ...
            <h3 class="text-dark mb-8 text-2xl font-semibold dark:text-white md:text-[28px] md:leading-[1.42]">
              Send us a Message
            </h3>
            <form>
              <div class="mb-[22px]">
                <label for="fullName" class="text-body-color dark:text-dark-6 mb-4 block text-sm">Full Name*</label>
              ...
              <div class="mb-[22px]">
                <label for="email" class="text-body-color dark:text-dark-6 mb-4 block text-sm">Email*</label>
                <input type="email" name="email" placeholder="example@yourmail.com"
                  class="text-body-color placeholder:text-body-color/60 dark:border-dark-3 dark:text-dark-6 w-full border-0 border-b border-[#f1f1f1] bg-transparent pb-3 focus:border-primary focus:outline-none">
              </div>
              <div class="mb-[22px]">
                <label for="phone" class="text-body-color dark:text-dark-6 mb-4 block text-sm">Phone*</label>
                <input type="text" name="phone" placeholder="+885 1254 5211 552"
                  class="text-body-color placeholder:text-body-color/60 dark:border-dark-3 dark:text-dark-6 w-full border-0 border-b border-[#f1f1f1] bg-transparent pb-3 focus:border-primary focus:outline-none">
              </div>
              <div class="mb-[30px]">
                <label for="message" class="text-body-color dark:text-dark-6 mb-4 block text-sm">Message*</label>
